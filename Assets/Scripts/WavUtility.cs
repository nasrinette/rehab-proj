...
public class WavUtility
{
	...
	public static byte[] FromAudioClip (AudioClip audioClip, out string filepath, bool saveAsFile = true, string dirPath = "recordings", string fileName = "audioFile")
	{
		...
		if (saveAsFile) {
			//filepath = string.Format ("{0}/{1}/{2}.{3}", , "wav");
